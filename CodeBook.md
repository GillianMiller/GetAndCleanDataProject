...
The data for this data set was derived from the source in the "Original Data" section above.
The description below has been adapted from the original data description.
...
The set of variables that were estimated from these signal include:
- mean: Mean value
- std: Standard deviation

The resultant tidy data set is the means of the variables for each activity and subject
